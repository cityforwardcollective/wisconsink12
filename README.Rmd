...
> :star: *Data is also written to a SQLite database, which is not tracked in this repository but is available for those wishing to access the data without using R. Contact Spencer Schien (<spencer.schien@cityforwardcollective.org>) if you are interested.*
